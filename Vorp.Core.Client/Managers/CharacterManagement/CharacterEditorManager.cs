...
namespace Vorp.Core.Client.Managers.CharacterManagement
{
    public class CharacterEditorManager : Manager<CharacterEditorManager>
    {
        ...
        private static void CreateBaseMenu(bool update = false)
        {
            ...
            characterBodyOptions.Add("CharacterSetComponent/Head", new Tuple<string, string, List<long>, long>(ClientConfiguration.Translation("character.body.head.label"), ClientConfiguration.Translation("character.body.head.description"), _ped.Heads, _ped.PedComponents.Head.Value));
